...
// dichiarazione e definizione della classe gaussiana
...
// definizione dei metodi e dei costruttori della classe funzione gaussiana
...
double gaussiana::eval(double x){ return (exp(-(x-_mu)*(x-_mu)/(2*_sigma*_sigma)))/(_sigma*sqrt(2*M_PI)); }
